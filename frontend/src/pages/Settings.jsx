...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Warning Banner - WhatsApp Ban Risk */}
      <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-amber-800">Peringatan Risiko Blokir WhatsApp</h3>
            <div className="mt-2 text-sm text-amber-700">
              <p>
                Aplikasi ini menggunakan library Baileys (unofficial) untuk menghubungkan ke WhatsApp. 
                <strong>Risiko blokir nomor</strong> selalu ada, terutama jika:
              </p>
              <ul className="list-disc list-inside mt-1 space-y-1">
                <li>Mengirim pesan dalam jumlah besar secara bersamaan</li>
                <li>Mengirim pesan ke nomor yang tidak dikenal terlalu banyak</li>
                <li>Menggunakan akun WhatsApp bisnis gratis</li>
                <li>Tidak menggunakan fitur Anti-Block dengan benar</li>
              </ul>
              <p className="mt-2">
                <strong>Saran:</strong> Gunakan nomor khusus untuk gateway, batasi jumlah pesan per hari, dan gunakan fitur Anti-Block.
              </p>
            </div>
          </div>
        </div>
